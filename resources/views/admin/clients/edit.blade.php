                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input name="video_url" id="videoUrl" @if($client) value="{{$client->video_url}}" @endif type="hidden">
                        </div>

                        <div class="card-footer p-4" @if(!$client->video_url) style="display: none" @endif>
                            <video id="videoPreview" @if($client) src="{{$client->video_url}}" @endif controls style="width: 100%; height: auto"></video>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input name="audio_url" id="audioUrl" @if($client) value="{{$client->audio_url}}" @endif type="hidden">
                        </div>

                        <div class="card-footer-audio p-4" @if(!$client->audio_url) style="display: none" @endif>
                            <audio
                                controls
                                id="audioPreview"
                                @if($client) src="{{$client->audio_url}}" @endif>
